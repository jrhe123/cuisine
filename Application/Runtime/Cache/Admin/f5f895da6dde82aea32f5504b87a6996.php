                ...
                <div class="portlet-title">
                    ...
                    <div class="tools">
                        <?php if(($_GET['action']) == "view"): ?><div class="tools">
                                <a href="<?php echo U('edit');?>?id=<?php echo ($id); ?>" class="btn btn-xs yellow margin-right-10"><i class="fa fa-edit"></i> 编辑</a>
                            </div><?php endif; ?>
                    </div>
                </div>
                        ...
                        <form id="form" class="form-horizontal form-bordered" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <select class="form-control bs-select" name="class">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">话题</label>
                                    <div class="col-md-7">
                                        <input type="hidden" name="topic" class="form-control select2" value="<?php echo ($topic); ?>">
                                        <select class="form-control bs-select" name="topic">
                                            <?php if(is_array($topics)): foreach($topics as $key=>$topic): ?><option value="<?php echo ($topic["id"]); ?>"><?php echo ($topic["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="title" value="<?php echo ($title); ?>" placeholder="必填" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="tags" value="<?php echo ($tags); ?>" placeholder="必填" />
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $("#attachment").fileupload({
                ...
                url: "<?php echo U('uploadAttachment');?>", // 上传地址
                dataType: "json",
                ...
                add: function(e, data) {
                    ...
                    if(data.result.code == 200) {
                        ...
                        $('.attachments').append(
                                '<div class="attachment-item">' +
                                '<div class="attachment-item">附件路径：' + data.result.accessPath + '' +
                                '&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-xs red" onclick="delAttachment(this)">删除</button> </div>' +
                                '<input type="hidden" name="attPaths[]" value="' + data.result.path + '">' +
                                '</div>');
                    }else {
