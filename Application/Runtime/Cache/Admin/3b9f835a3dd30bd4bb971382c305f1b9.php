...
<script>
    window.onload = function () {
        ...
        $("#picture").fileupload({
            ...
            url: "<?php echo U('Upload/singlePicture');?>?size=458-550", // 上传地址
            dataType: "json",
                ...
                if (progress <= 100) {
                    ...
                    progressObj.html("上传成功");
                                    ...
                                    <div class="col-md-offset-3 col-md-9" style="padding-top: 0px;">
                                        <span class="help-block">图片支持JPG、PNG、BMP格式，图片大小建议保持在458*550像素，大小不能超过1M</span>
                                    </div>
                                </div>
                                <div class="form-group">
...
//            editor.sync();  //编辑器需调用这个来获取html
            if ($('#form').validate().form()) {
                showBlockUI();
                $.post('<?php echo U("Course/saveSetting");?>', $('#form').serialize(), function (data) {
        ...
        // 返回列表
        function goList() {
            window.location.href = "<?php echo U('setting');?>";
        }
    </script>
