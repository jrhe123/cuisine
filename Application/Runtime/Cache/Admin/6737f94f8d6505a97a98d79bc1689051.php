...
<div class="page-container">
    ...
    <a href="<?php echo U('classify_add');?>" class="btn blue">添加</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要删除该分类？操作将无法恢复！</h4>
            </div>
            <div class="modal-body">
                <p>您确定要删除该分类？操作将无法恢复！</p>
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn">关闭</button>
                <!--<button type="button" data-dismiss="modal" class="btn red" onclick="noPassAudit()">不通过审核</button>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要显示该分类？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要显示该分类？</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要隐藏该分类？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要隐藏该分类？</p>
            </div>
...
//            $('select[name="company_status"]').val('<?php echo ($company_status); ?>');
            ...
            grid = ajaxDataTableJs('dataTable', '<?php echo U("classifyTableData");?>', order, columns);
        ...
        function yesDel() {
            $.post('<?php echo U("classify_del");?>', {id: id}, function (data) {
