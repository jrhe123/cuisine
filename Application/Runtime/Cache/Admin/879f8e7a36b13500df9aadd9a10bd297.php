...
<div class="page-container">
    ...
    <a href="<?php echo U('setting_add');?>" class="btn blue">添加</a>
            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    <?php if(($_SESSION['cooking_admin_role']) == "admin"): ?><ul class="nav nav-tabs">
                            <?php if($_GET['type']== 1): ?><li class="active">
                                    <a href="?type=1">分类</a>
                                </li>
                                <li class="">
                                    <a href="?type=2">话题</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">审核分类/话题</h4>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要删除该分类/话题？操作将无法恢复！</h4>
            </div>
            <div class="modal-body">
                <p>您确定要删除该分类/话题？操作将无法恢复！</p>
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn">关闭</button>
                <!--<button type="button" data-dismiss="modal" class="btn red" onclick="noPassAudit()">不通过审核</button>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要显示该分类/话题？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要显示该分类/话题？</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要隐藏该分类/话题？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要隐藏该分类/话题？</p>
            </div>
...
//            $('select[name="company_status"]').val('<?php echo ($company_status); ?>');
            ...
            grid = ajaxDataTableJs('dataTable', '<?php echo U("settingTableData");?>?type=<?php echo ($_GET['type']); ?>', order, columns);
