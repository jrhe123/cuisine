...
<div class="page-container">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    <?php if(($_SESSION['cooking_admin_role']) == "admin"): ?><!--<ul class="nav nav-tabs">-->
                            <!--<?php if(is_array(C("COURSE_COLUMN"))): foreach(C("COURSE_COLUMN") as $key=>$course_column): ?>-->
                                <!--<?php if($_GET['course_column']== $key): ?>-->
                                    <!--<li class="active">-->
                                        <!--<a href="?course_column=<?php echo ($key); ?>"><?php echo ($course_column); ?></a>-->
                                    <!--</li>-->
                                    <!--<?php else: ?>-->
                                    <!--<li>-->
                                        <!--<a href="?course_column=<?php echo ($key); ?>"><?php echo ($course_column); ?></a>-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-dismiss="modal" class="btn blue" onclick="pass()">通过审核</button>
                </div>
            </div>
        </div>
    </div>
    <div id="reasonModal" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                ...
                <div class="modal-body">
                    ...
                    <font>请填写审核不通过的原因</font>
                </div>
                <div class="modal-footer">
                    <button type="button" data-dismiss="modal" class="btn">关闭</button>
                    <button type="button" data-dismiss="modal" class="btn red" onclick="noPassSubmit()">不通过审核</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要删除该申请？操作将无法恢复！</h4>
            </div>
            <div class="modal-body">
                <p>您确定要删除该申请？操作将无法恢复！</p>
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn">关闭</button>
                <!--<button type="button" data-dismiss="modal" class="btn red" onclick="noPassAudit()">不通过审核</button>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要显示该申请？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要显示该申请？</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要隐藏该申请？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要隐藏该申请？</p>
            </div>
...
//            $('select[name="company_status"]').val('<?php echo ($company_status); ?>');
            ...
            grid = ajaxDataTableJs('dataTable', '<?php echo U("applyData");?>', order, columns);
        ...
        function pass() {
            $.post('<?php echo U("audit");?>', {id: id ,status:1}, function (data) {
                if (data.code == 200) {
        ...
        function noPassSubmit() {
            ...
            $.post('<?php echo U("audit");?>', {id: id, reason: reason ,status:2}, function (data) {
                if (data.code == 200) {
                    toastMsg('success', data.msg, '提示信息');
                    location.reload();
                } else {
