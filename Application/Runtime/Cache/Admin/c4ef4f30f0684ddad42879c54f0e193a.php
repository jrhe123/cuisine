                        ...
                        <form id="form" class="form-horizontal form-bordered" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">图片添加</label>
...
<script>
    window.onload = function () {
        ...
        $("#picture").fileupload({
            ...
            url: "<?php echo U('Upload/singlePicture');?>", // 上传地址
            dataType: "json",
                ...
                if (progress <= 100) {
                    ...
                    progressObj.html("上传成功");
                                    ...
                                    <div class="col-md-offset-3 col-md-9" style="padding-top: 0px;">
                                        <span class="help-block">图片支持JPG、PNG、BMP格式，图片大小建议保持在1920*650像素，大小不能超过1M</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="rank" value="<?php echo ($rank); ?>" placeholder="选填" />
                                    </div>
                                </div>
    ...
    <script>
        ...
        function formSubmit() {
            ...
            if ($('#form').validate().form()) {
                $.post('<?php echo U("saveBanner");?>', $('#form').serialize(), function (data) {
        ...
        // 返回列表
        function goList() {
            window.location.href = "<?php echo U('banner_index');?>";
        }
