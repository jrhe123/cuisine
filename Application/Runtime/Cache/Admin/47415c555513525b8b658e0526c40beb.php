...
<div class="page-container">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    <!--<?php if(($_SESSION['cooking_admin_role']) == "admin"): ?>-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">审核课程文章</h4>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要删除该课程文章？操作将无法恢复！</h4>
            </div>
            <div class="modal-body">
                <p>您确定要删除该课程文章？操作将无法恢复！</p>
            </div>
            <div class="modal-footer">
                <button type="button" data-dismiss="modal" class="btn">关闭</button>
                <!--<button type="button" data-dismiss="modal" class="btn red" onclick="noPassAudit()">不通过审核</button>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要显示该课程文章？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要显示该课程文章？</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">您确定要隐藏该课程文章？</h4>
            </div>
            <div class="modal-body">
                <p>您确定要隐藏该课程文章？</p>
            </div>
...
<script>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            grid = ajaxDataTableJs('dataTable', '<?php echo U("settingData");?>', order, columns);
        ...
        function yesDel() {
            $.post('<?php echo U("delSetting");?>', {id: id}, function (data) {
        ...
        function yesShow() {
            $.post('<?php echo U("showSetting");?>', {id: id}, function (data) {
                if (checkAjaxReturn(data)) {
                    setTimeout('window.location.reload();', 1000);
                }
            }, 'json');
        ...
        function yesHide() {
            $.post('<?php echo U("hideSetting");?>', {id: id}, function (data) {
                if (checkAjaxReturn(data)) {
                    setTimeout('window.location.reload();', 1000);
                }
            }, 'json');
