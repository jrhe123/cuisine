                    ...
                    <div class="form-style form-style-4">
                        <form id="form" onsubmit="return false">
                            <div class="form-inputs clearfix">
                                <p>
                                    <label>昵称</label>
                                    <input value="<?php echo ($nickname); ?>" name="nickname" type="text">
                                </p>

                                <p>
                                    <label class="required">真实姓名<span>*</span></label>
                                    <input value="<?php echo ($r_username); ?>" name="r_username" type="text">
                                </p>
                            ...
                            <div class="form-style form-style-2">
                                <div class="user-profile-img"><img src="<?php echo ($head_img); ?>"></div>
                                <p class="user-profile-p">
                                    <label>个人头像</label>

                                <div class="fileinputs">
                                    <input type="file" class="file" id="picture">
                                    <input name="picture" type="hidden" value="<?php echo ($picture); ?>" />
                                    <div class="fakefile">
                                ...
                                <p>
                                    <label>自我介绍</label>
                                    <textarea name="signature" cols="58" rows="8"><?php echo ($signature); ?></textarea>
                                </p>
                            </div>
                            <p class="form-submit">
            ...
            <aside class="col-md-3 sidebar">
                <div class="widget widget_stats">
                    ...
                    <div class="ul_list ul_list">
                        <ul>
                            <li><i class="fa fa-file-o"></i><a href="<?php echo U('Profile/draft');?>?id=<?php echo (session('cooking_user_id')); ?>">我的草稿</a></li>
                            <li><i class="fa fa-bookmark-o"></i><a href="<?php echo U('Profile/course');?>?id=<?php echo (session('cooking_user_id')); ?>">我的课程</a></li>
                            <li><i class="fa fa-check-square-o"></i><a href="<?php echo U('Profile/focus');?>?id=<?php echo (session('cooking_user_id')); ?>">我的关注人</a></li>
                        </ul>
                    </div>
                </div>
...
//                    toastMsg('error', data.msg, '提示信息');
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('select[name="gender"]').val('<?php echo ($gender_n); ?>');
            // 图片上传
            $("#picture").fileupload({
        ...
        // 提交
        function formSubmit() {
            $.post('<?php echo U("edit");?>', $('#form').serialize(), function (data) {
