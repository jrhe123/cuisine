        ...
        <nav class="header-top-nav">
            <ul>
                ...
                <?php if(empty($_SESSION['cooking_user_id'])): ?><li><a href="login.html" id="login-panel"><i class="fa fa-user"></i>登录</a></li>
                    <?php else: ?>
                    <li class="user">
                        <img style="max-width: 40px;float: left;margin-right: 10px;" src="/Public/home/images/admin.jpg" alt=""/>
		...
		<div class="row">
			<div class="col-md-9">
				<article class="question single-question question-type-normal">
					<h2>
						<a href="single_question.html">招中餐厨师</a>
					</h2>
					...
					<div class="question-inner">
						...
						<div class="question-desc">
                            ...
                            <p>•	性别：男</p>
                            <p>•	年龄：25-40岁</p>
                            <p>•	联系电话：13569569548</p>
                            <p>•	联系人：冯先生</p>
                            <p>•	生活福利：包吃；包住；</p>
                            <p style="font-weight: 700;">职位描述：</p>
                            <p>语言要求:粤语流利</p>
                            <p>职位要求:</p>
                            <p>有相关工作经验，熟手炒锅，熟悉中餐菜系，做事认真负责，责任心强，服从工作安排。</p>
                            <p>工作时间:10个钟(含吃饭时间)（营业时间最夜晚上十点）</p>
                            <p>休息时间：4天</p>
                            <p>工作内容：主要负责餐厅内菜式出品。</p>
                            <p>薪酬待遇：试用期月薪8000mop，试用期三个月后8500mop，根据工作表现每半年加500mop，包吃住，具体工资面议。（以上资讯以面试当日为准）</p>
                            <p>注意事项:</p>
                            <p>以上工作在澳门工作，我们会收取介绍费用，请考虑清后致电咨询，白天接听钱小姐固话时间为:上午9:00-下午5:30编号(8A55601)</p>
						</div>
