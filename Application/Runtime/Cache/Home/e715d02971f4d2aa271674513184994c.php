...
<div id="wrap" class="grid_1200">
    ...
    <section style="margin-bottom: 100px; margin-top: 50px" class="container main-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="page-content">
                    ...
                    <p>付款项目:<?php echo ($course["title"]); ?></p>

                    <p>应付金额:￥<?php echo ($course["price"]); ?></p>

                    <p>付款人:<?php echo ($user["r_username"]); ?></p>

                    <p>联系电话:<?php echo ($user["phone"]); ?></p>
                    <p>备注：<?php echo ($apply["remark"]); ?></p>
                    <p>支付方式:汇款（账号:13138900000342）</p>
                </div>
            </div>
            <!-- End main -->
        </div>
