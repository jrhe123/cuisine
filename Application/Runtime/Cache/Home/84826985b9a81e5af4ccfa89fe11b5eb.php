                ...
                <div class="col-md-12">
                    <div class="crumbs">
                        ...
                        <span class="current-page">
                            <a href="<?php echo U('Train/index');?>">
                                <?php if($column == 0): ?>烹饪工艺与营养
                                    <?php else: ?>
                                    分享课程<?php endif; ?>
                            </a>
                        </span>
                        <span class="crumbs-span">/</span>
                        <span class="current-page"><?php echo ($title); ?></span>
                    </div>
                </div>
            </div>
            <!-- End row -->
                ...
                <article class="post clearfix">
                    <div class="post-inner">
                        <div class="flexslider blog_silder margin_b_20 post-img">
                            <ul class="slides">
                                <?php if(is_array($pictures)): foreach($pictures as $key=>$pic): ?><li><img class="img-responsive" src="<?php echo ($pic); ?>" alt=""></li><?php endforeach; endif; ?>
                            </ul>
                        </div>
                        <!-- End flexslider -->
                        <div class="tabs-warp">
                            ...
                            <div class="tab-inner-warp">
                                <div class="tab-inner">
                                    <?php if(!empty($course_price)): ?><h5>培训收费</h5>
                                        <p><span class="price"><?php echo ($course_price); ?></span></p><?php endif; ?>
                            ...
                            <!--</div>-->
                            <!--</div>-->
                            <?php if(!empty($vurl)): if($is_audit == 0): ?><embed class="col-md-12" src="<?php echo ($vurl); ?>" allowFullScreen="true" quality="high" width="100%" height="700" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed><?php endif; endif; ?>
                        </div>
                        <?php if($is_audit == 1): ?><a class="button large green-button col-md-12 col-xs-12 t_center" href="javascript:;" onclick="jump()"
                               style="">在线报名</a><?php endif; ?>
                    </div>
                    <!-- End post-inner -->
                </article>
                <!-- End article.post -->
...
//                    toastMsg('error', data.msg, '提示信息');
    ...
    <script>
        var current_user_id = '<?php echo (session('cooking_user_id')); ?>';
        var current_r_user_name = '<?php echo (session('cooking_r_user_name')); ?>';
        jQuery(document).ready(function () {
        ...
        function jump(){
            if(current_user_id == ''){
                ...
                window.location.href='<?php echo U("Train/apply");?>?id=<?php echo ($_GET['id']); ?>';
            }
        }
