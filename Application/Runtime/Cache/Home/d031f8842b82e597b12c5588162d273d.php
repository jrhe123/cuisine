...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/home/css/bootstrap-select.css"/>
                    ...
                    <div class="crumbs">
                        ...
                        <span class="current-page">
                            <a href="<?php echo U('Train/index');?>">
                                <?php if($course["column"] == 0): ?>烹饪工艺与营养
                                    <?php else: ?>
                                    分享课程<?php endif; ?>
                            </a>
                        </span>
                        <span class="crumbs-span">/</span>
                        <span class="current-page"><?php echo ($course["title"]); ?></span>
                        <span class="crumbs-span">/</span>
            ...
            <div class="col-md-12">
                ...
                <div class="page-content">
                    ...
                    <div class="form-style form-style-3" id="question-submit">
                        <form id="form" method="post" action="<?php echo U('Train/result');?>" onsubmit="return false">
                            <!--<div class="form-inputs clearfix">-->
                                <!--<p>-->
                                ...
                                <!--</p>-->
                            <!--</div>-->
                            <p><div class="user-profile-img"><img src="<?php echo ($head_img); ?>" alt=""/></div></p>
                            <p>昵称：<?php echo ($nickname); ?></p>
                            <p>真实姓名：<?php echo ($r_username); ?></p>
                            <p>性别：<?php echo ($gender); ?></p>
                            <p>联系电话：<?php echo ($phone); ?></p>
                            <p>注册时间：<?php echo ($created_timestamp); ?></p>
...
<script src="/Public/global/plugins/icheck/icheck.min.js"></script>
    ...
    <script src="/Public/home/js/bootstrap-select.js"></script>
    ...
    <script>
        ...
        function formSubmit() {
            ...
            if($('input[name="course_id"]').val() != ''){
                $.post('<?php echo U("apply");?>', $('#form').serialize(), function (data) {
        ...
        function jump(id){
            window.location.href = '<?php echo U("Train/result");?>?id='+id;
        }
    </script>
