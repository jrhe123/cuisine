                ...
                <div class="tabs-warp question-tab">
                    ...
                    <div class="tab-inner-warp">
                        <ul class="zm-topic-cat-main clearfix">
                            ...
                            <?php if(is_array($class)): foreach($class as $key=>$v): ?><li data-id="<?php echo ($v["id"]); ?>"><a href="#<?php echo ($v["name"]); ?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
                        </ul>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data.data, function (k, v) {
                            ...
                            '<a href="<?php echo U("Train/article");?>?id=' + v.id + '">' + v.title + '</a></h2>' +
                            '<div class="post-img"><a href="<?php echo U("Train/article");?>?id=' + v.id + '">' +
                            ...
                            '<a href="<?php echo U("Train/article");?>?id=' + v.id + '" class="post-read-more button color small">查看详细</a>' +
                            '</div>' +
                            '</div>' +
                            '</article> '
                        });
