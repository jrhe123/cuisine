            ...
            <div class="col-md-9">
                ...
                <div class="page-content page-content-user">
                    <div class="user-questions">
                        <div class="boxedtitle page-title" style="padding-top: 20px;"><h2>我的问题</h2></div>
                        <article class="question user-question">
                            <p class="tag">【分享】<span>面食</span> <span>发酵</span> <span>美食</span> <span>传统美食</span></p>

                            <h3>
                                <a href="<?php echo U('Index/detail');?>">如何使面粉更好发酵</a>
                            </h3>

                            <div class="question-content">
                                <div class="question-bottom">
                                    <span class="question-favorite"><i class="fa fa-star"></i>5</span>
                                    <span class="question-date"><i class="fa fa-clock-o"></i>2015-05-05</span>
                                    <span class="question-comment"><a href="#"><i class="fa fa-comment"></i>5
                                        回复</a></span>
                        ...
                        <article class="question user-question">
                            <p class="tag">【分享】<span>烧饼</span> <span>烧饼</span> <span>马蹄</span> <span>传统美食</span></p>

                            <h3>
                                <a href="<?php echo U('Index/detail2');?>">马蹄烧饼的制作与奥妙</a>
                            </h3>
                        ...
                        <article class="question user-question">
                            <p class="tag">【工作】<span>厨师</span> <span>山东</span> <span>招聘</span></p>

                            <h3>
                                <a href="<?php echo U('Index/detail3');?>">诚聘厨师8000月薪包吃住在山东</a>
                            </h3>
                        ...
                        <article class="question user-question">
                            <p class="tag">【工作】<span>厨师</span> <span>中餐</span> <span>招聘</span></p>

                            <h3>
                                <a href="<?php echo U('Index/detail4');?>">招中餐厨师</a>
                            </h3>
                        ...
                        <article class="question user-question">
                            <p class="tag">【工作】<span>厨师</span> <span>湘菜</span> <span>招聘</span></p>

                            <h3>
                                <a href="<?php echo U('Index/detail5');?>">湘赣木桶饭诚聘湘菜厨师</a>
                            </h3>
